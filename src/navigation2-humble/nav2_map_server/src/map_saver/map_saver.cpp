...
MapSaver::on_configure(const rclcpp_lifecycle::State & )
{
...
nav2_util::CallbackReturn
MapSaver::on_activate(const rclcpp_lifecycle::State & )
{
...
nav2_util::CallbackReturn
MapSaver::on_deactivate(const rclcpp_lifecycle::State & )
{
...
nav2_util::CallbackReturn
MapSaver::on_cleanup(const rclcpp_lifecycle::State & )
{
...
nav2_util::CallbackReturn
MapSaver::on_shutdown(const rclcpp_lifecycle::State & )
{
